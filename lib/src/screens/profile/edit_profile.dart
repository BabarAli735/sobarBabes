...
import 'package:sobarbabe/src/widgets/user_gallery.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final _schoolController =
      TextEditingController(text:'userSchool');
  final _jobController =
      TextEditingController(text:'userJobTitle');
  final _bioController = TextEditingController(text:'userBio');
          ...
          child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: "school",
                      hintText: "enter_your_school_name",
                      floatingLabelBehavior: FloatingLabelBehavior.always,
                      prefixIcon: const Padding(
                ...
                TextFormField(
                  ...
                  validator: (job) {
                    if (job == null) {
                      return "please_enter_your_job_title";
                    }
                    return null;
                  },
                ),
